...
public interface DependencyResolver
{
	...
	/**
	 * Risolve le dipendenze di una data collezione di {@link DependentBean}
	 * restituendo in uscita la lista ordinata delle dipendenze che devono
	 * essere soddisfatte.
	 * 
	 * Resolves dependencies of given {@link DependentBean} list returning an
	 * ordered list of dependencies that need to be satisfied.
	 * 
